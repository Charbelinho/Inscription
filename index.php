...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="index.html"><span>Business</span>School</a></h1>
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Formations</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="about.html">BTS</a></li>
                            <li><a href="#">Licence Professionnelle</a></li>
                            <li><a href="#">Master</a></li>
                        </ul>
                    </li>

                    <li><a href="Inscription/new.php">Inscription</a></li>
                    <li><a href="services.html">Services</a></li>
                    <li><a href="portfolio.html">A propos</a></li>
                </ul>
